...
Namespace WindowsApplication1
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.schedulerControl1.Start = New System.DateTime(2010, 3, 25, 0, 0, 0, 0)
...
'			Me.schedulerControl1.AppointmentResized += New DevExpress.XtraScheduler.AppointmentResizeEventHandler(Me.schedulerControl1_AppointmentResizing);
...
'			Me.schedulerControl1.AppointmentResizing += New DevExpress.XtraScheduler.AppointmentResizeEventHandler(Me.schedulerControl1_AppointmentResizing);
'			Me.schedulerControl1.AllowAppointmentResize += New DevExpress.XtraScheduler.AppointmentOperationEventHandler(Me.schedulerControl1_AllowAppointmentResize);
			' 
			' barManager1
			' 
			...
			Me.bar2.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() { New DevExpress.XtraBars.LinkPersistInfo(Me.barEditItem1), New DevExpress.XtraBars.LinkPersistInfo(Me.barButtonItem1)})
...
'			Me.barButtonItem1.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.barButtonItem1_ItemClick);
			...
			' schedulerStorage1
			' 
			Me.schedulerStorage1.Appointments.DateSaving = DevExpress.XtraScheduler.DateSavingType.UTC
			Me.schedulerStorage1.Resources.ColorSaving = DevExpress.XtraScheduler.ColorSavingType.ArgbColor
'			Me.schedulerStorage1.FilterResource += New DevExpress.XtraScheduler.PersistentObjectCancelEventHandler(Me.schedulerStorage1_FilterResource);
